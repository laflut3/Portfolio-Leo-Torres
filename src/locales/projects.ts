    ...
    projects: {
      ...
      entries: [
        ...
        },
        {
          ...
          themes: ['personal'],
          categories: ['Documentation', 'Produit logiciel'],
          languages: [],
          githubUrl: 'https://github.com/FleoThing/docs-LeMontage',
          text: 'Documentation du projet LeMontage.',
          details:
            'Dépôt personnel privé référencé ici pour situer le travail de documentation associé à l’écosystème LeMontage.',
          stack: ['Documentation', 'Projet privé'],
        },
        {
          title: 'Hub LeMontage',
          themes: ['personal'],
          categories: ['Application web', 'Collaboration', 'Produit logiciel'],
          languages: [],
          githubUrl: 'https://github.com/FleoThing/Hub-LeMontage',
          text: 'Plateforme collaborative de l’écosystème LeMontage.',
          details:
            'Dépôt personnel privé référencé ici comme partie du travail produit autour de LeMontage.',
          stack: ['Plateforme web', 'Projet privé'],
        },
        {
          title: 'LeMontage',
          themes: ['openSource'],
    ...
    projects: {
      ...
      entries: [
        ...
        },
        {
          title: 'docs-LeMontage',
          themes: ['personal'],
          categories: ['Documentation', 'Software product'],
          languages: [],
          githubUrl: 'https://github.com/FleoThing/docs-LeMontage',
          text: 'Documentation for the LeMontage project.',
          details:
            'A private personal repository listed here to place the documentation work associated with the LeMontage ecosystem.',
          stack: ['Documentation', 'Private project'],
        },
        {
          title: 'Hub LeMontage',
          themes: ['personal'],
          categories: ['Web application', 'Collaboration', 'Software product'],
          languages: [],
          githubUrl: 'https://github.com/FleoThing/Hub-LeMontage',
          text: 'A collaborative platform in the LeMontage ecosystem.',
          details:
            'A private personal repository listed here as part of the product work around LeMontage.',
          stack: ['Web platform', 'Private project'],
        },
        {
          title: 'LeMontage',
          themes: ['openSource'],
